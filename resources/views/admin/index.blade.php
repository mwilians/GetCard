                                ...
                                <div class="col-xl-6">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-body p-0">
                                            ...
                                            <!--begin::Block-->
                                            {{-- <div class="bg-light-primary p-3 rounded-xl ml-8">
                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center mb-0">
                                                    ...
                                                    <div>
                                                        <div class="font-size-sm font-weight-bold">Rp. 150000</div>
                                            ...
                                            <div class="col-12">
                                                <div id="kt_charts_widget_6_chart" class="card-rounded-bottom"
                                                data-color="success" style="height: 150px"></div>
                                            </div>

                                            <div class="bg-light-info p-2 rounded-xl ml-8">
                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center mb-0">
                                                    <div class="symbol symbol-circle symbol-white symbol-30 flex-shrink-0 mr-3">
                                                        <div class="symbol-label">
