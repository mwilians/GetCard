    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    <span class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                        {{ Auth::user()->name }} {{ \App\Http\Controllers\User\UserController::cekPremium () ? '👑' : '' }}
                    </span>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="user/premium" class="navi-item">
                    <div class="navi-link">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="user/tentang-premium" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="user/histori-pembayaran" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
